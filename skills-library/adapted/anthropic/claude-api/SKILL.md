---
name: claude-api
# Modified by Agentic Operator: shortened discovery description; original in references/UPSTREAM-SKILL.md.
description: "Build and debug applications using the Claude API, Anthropic SDK, Claude Agent SDK, streaming, tool use, MCP, prompt caching, and model migration. Use for Claude or Anthropic implementation questions and model-specific API guidance. Do not select for work on other model providers."
