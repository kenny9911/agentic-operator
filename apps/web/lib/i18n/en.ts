...
export const en = {
  ...
  runs: {
    ...
    executionHistoryHint: "One execution = every agent run sharing a subject",
    executionSubject: "Subject",
    executionAgents: "Agents",
    executionRuns: "Runs",
    executionStarted: "Started",
    executionLastActivity: "Last activity",
    executionEmpty: "No executions with a subject yet",
    executionOpen: "Open flow",
    executionBack: "Back to history",
    executionViewing: "Viewing a past execution",
  ...
  runInput: {
    heading: "Prompt, files and context",
    prompt: "User prompt",
    promptPlaceholder: "What would you like the agent or workflow to do?",
    fileOnlyPrompt: "Use the attached files as input and follow the agent or workflow instructions.",
    files: "Files and images",
    filesHint: "Upload up to {count} files, {sizeMiB} MiB each: PDF, PNG, JPG, GIF, WebP, or text (TXT, MD, CSV, TSV, JSON, XML, HTML, HTM, LOG). Text files are read directly; AI extracts text from PDFs and images. Review and edit the text before running. Each attachment allows {attachmentChars} characters; all run input combined allows {totalChars}.",
    parsing: "Reading this file…",
    reviewText: "Extracted text — edit before running",
    remove: "Remove",
    removeFile: "Remove {name}",
    retry: "Retry parsing",
    tooManyFiles: "Attach up to {count} files. Remove a file before adding more.",
    unsupportedFile: "{name} is not a supported file type.",
    invalidSize: "{name} must not be empty and must be no larger than {sizeMiB} MiB.",
    tooMuchText: "Shorten the prompt, context, or extracted text. The prompt and context each allow {textChars} characters; each attachment allows {attachmentChars}; the combined limit is {totalChars}.",
    contextAndMemory: "Context and memory",
    context: "Additional context",
    contextPlaceholder: "Background, preferences, or constraints for this run",
    memorySession: "Memory session name (optional)",
    memoryPlaceholder: "For example: quarterly-report",
    memoryHint: "Reuse a session name to recall the 4 most recent successful run excerpts in this business domain. Draft and live memory are separate. Leave blank for no shared session memory.",
    memoryEnabled: "Session memory enabled.",
    agentDescription: "Describe your request, attach files or images, and review the extracted text before running the agent.",
    structuredInput: "Structured input (advanced)",
  },
  runWithInputModal: {
  ...
  agentEditor: {
    taskInstructions: "What should this agent do?",
    taskInstructionsHelp: "Describe the work in plain language. Connected results are supplied automatically.",
    taskInstructionsPlaceholder: "For example: Summarize the previous result, check the evidence, and recommend the next action.",
    taskPromptAria: "Task instructions {index}",
    taskInstructionsAdvanced: "This step uses tools or a human task. Edit its system instructions below, or configure its actions in Advanced settings.",
    previousResults: "Results from previous agents",
    previousResultsHelp: "Each connection brings the previous agent’s output into this agent’s context. Use the reference below when you want to name a particular result in your instructions.",
    connectToReceive: "Connect another agent’s output to this agent’s input to receive its result automatically.",
    resultAvailable: "Available to this agent when the connected step completes.",
    resultBindingMissing: "No explicit binding. Review input mappings in Advanced settings.",
    expectedResults: "What should this agent return?",
    expectedResultsHelp: "Describe each result. The workflow checks the returned values before passing them to the next agent.",
    outputDescriptionAria: "Description of output {output}",
    outputDescriptionPlaceholder: "Describe what the next agent needs from this result.",
    noTypedResults: "Connect this agent to a next step to generate a result contract, or define outputs in Advanced settings.",
    advancedSettings: "Advanced settings",
    advancedSettingsHelp: "Change event wiring, input mappings, output schemas, tools, actions, and execution limits.",
    handoffBindings: "Input and output mappings",
    handoffBindingsHelp: "Connections generate these mappings. Override a path, template, or constant to control exactly what is sent and received. Complete definition includes all settings.",
    inputBindings: "Incoming event → agent inputs (JSON)",
    outputBindings: "Agent outputs → outgoing event (JSON)",
    invalidBindings: "Enter a valid mapping object with path, template, input, output, or constant bindings.",
    editBadge: "EDIT",
  ...
  workflowPage: {
    ...
    canvasCoach: "Drag nodes or edges to arrange · drag output to input to connect",
    canvasViewCoach: "Drag nodes or edges to arrange · layout saved in this browser",
    edgeMoveHint: "Drag to bend the edge. Arrow keys move it; Shift moves faster; Home resets the route.",
    fitLayout: "Fit to view",
    resetLayout: "Reset layout",
    layoutReset: "Display layout reset.",
    ...
    nodeViewTitle:
      "Drag to move {title}. Click for details; double-click to expand. Arrow keys move; Shift moves faster.",
    newBadge: "NEW",
    modifiedBadge: "MOD",
