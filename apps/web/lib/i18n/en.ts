...
export const en = {
  ...
  runInput: {
    ...
    filesHint: "Upload up to 5 files, 8 MiB each: PDF, PNG, JPG, GIF, WebP, or text (TXT, MD, CSV, TSV, JSON, XML, HTML, HTM, LOG). AI reads each file; review and edit the extracted text before running.",
    parsing: "AI is reading this file…",
    ...
    invalidSize: "{name} must not be empty and must be no larger than 8 MiB.",
    tooMuchText: "Shorten the prompt, context, or extracted text. Each field allows 32,000 characters; the combined limit is 100,000.",
    ...
    agentDescription: "Describe your request, attach files or images, and review the AI-extracted text before running the agent.",
