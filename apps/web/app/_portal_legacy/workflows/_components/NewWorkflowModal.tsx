...
export function NewWorkflowModal({ onClose }: { onClose: () => void }) {
  const [path, setPath] = useState<"blank" | "template" | "import">(
    "template",
  );
        ...
        >
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ fontSize: 11, color: "var(--text-3)" }}>
                Workflows are versioned per-tenant. You&apos;ll be able to
          ...
          <div style={{ padding: 18, overflow: "auto", flex: 1 }}>
            ...
            >
              <PathCard
                ...
                icon="plus"
                title="Blank canvas"
                sub="Start with one trigger agent and build out from there."
              />
              <PathCard
                ...
                icon="workflow"
                title="From template"
                sub="Pre-built workflows for common patterns."
              />
              <PathCard
                active={path === "import"}
                ...
                sub="Drop a workflow.json + actions.json."
              />
            </div>
            ...
            {path === "blank" && (
              <div>
                ...
                >
                  ...
                  >
                    We&apos;ll create a single agent stub. You&apos;ll add
                    downstream agents and wire events on the canvas.
                  </div>
                </div>
              </div>
            )}
            ...
            {path === "import" && (
              <div>
                ...
                >
                  We accept the same schema as{" "}
                  <span className="mono">RAAS</span>:{" "}
                  <span className="mono">
                    id, name, actor, trigger[], actions[], triggered_event[]
                  </span>
                  . We&apos;ll validate the graph and report any cycles or
                  orphans before letting you save.
                </div>
              </div>
            )}
          </div>
          ...
          >
            ...
            >
              ...
              <span>
                Will save as draft. Deploy later from the workflow page.
              </span>
            </div>
            <div
