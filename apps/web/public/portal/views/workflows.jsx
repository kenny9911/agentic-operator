...
function Workflows({ navigate, liveStream, tenant }) {
  ...
  const [showImport, setShowImport] = useStateWf(false);
      ...
      <ViewHeader
        ...
        action={editing
          ...
          : [
              ...
              <Button key="upload" icon="upload" small onClick={() => setShowImport(true)}>Import manifest</Button>,
            ]
        }
      />
