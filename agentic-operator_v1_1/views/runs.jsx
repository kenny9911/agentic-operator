...
function RunDetail({ run, navigate }) {
  ...
  return (
    <div style={{ padding: 24, display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      {/* Stats strip */}
      <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: 0, border: "1px solid var(--border)", borderRadius: 6, background: "var(--panel)" }}>
