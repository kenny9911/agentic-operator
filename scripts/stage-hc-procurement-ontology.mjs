...
const PROMPT_PREAMBLE = {
  collectChainExecutionData: [
    ...
    "",
    "第 0 步 · 范围键：管理单元与库存组织由平台自动补进每个查询（unitCode / organizationCode），",
    "**你不要再传这两个字段**。其余入参一律用 metaERP 的小驼峰命名（如 pbpNumberList、",
    "itemCodeList、prCreationDateFrom），不要用本体里的下划线写法，否则接口会当成没传。",
    "",
